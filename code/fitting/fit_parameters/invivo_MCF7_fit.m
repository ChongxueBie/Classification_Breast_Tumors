...
[w_x, Z_x, P, rowname, Ztab]=LOAD_xls_qCEST_2_Ztab({'MCF-7'});
...
T.lowerB      = [   Sim.dwB-0.1    Sim.fB*0.01  Sim.kBA/5     Sim.R2B/10      ];
T.upperB      = [   Sim.dwB+0.1    Sim.fB*100    Sim.kBA*5    Sim.R2B*10     ];
...
T.lowerD      = [Sim.dwD-0.1   Sim.fD*0.01    Sim.kDA/2     Sim.R2D/10            ];
T.upperD      = [Sim.dwD+0.1   Sim.fD*100     Sim.kDA*2    Sim.R2D*100            ];
