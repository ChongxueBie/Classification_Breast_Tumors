...
% amide pool D
Sim.n_cest_pool=2;
Sim.fD=0.0033;  % rel. conc 190mM/111M
...
% NOE pool E
Sim.n_cest_pool=3;
Sim.fE=0.0057;  % rel. conc 35mM/111M
...
Sim.n_cest_pool=4;
Sim.fF=0.03;  % rel. conc 35mM/111M
...
%%
path = "/Users/cbie1/OneDrive - Johns Hopkins/JHU/CEST/Machine_Learning_BreastTumor/double_tumor/material_paper/20200824/M3_2/M3_2_Ztab_MCF_7.mat";
expdata = load(path);
...
% saveSimData = [savedir, '/sim_MCF_7.mat'];
