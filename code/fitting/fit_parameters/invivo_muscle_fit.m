...
[w_x, Z_x, P, rowname, Ztab]=LOAD_xls_qCEST_2_Ztab({'muscle'});
...
% 1 CEST pool B (Cr)
Sim.n_cest_pool=1;
Sim.fB=0.0006;  % rel. conc 190mM/111M
...
% 2 CEST pool D (amide)
Sim.n_cest_pool=2;
Sim.fD=0.00098;  % rel. conc 190mM/111M
...
% 3 CEST pool F (PCr)
Sim.n_cest_pool=3;
Sim.fE=0.00043;  % rel. conc 180mM/111M
...
T.upperB      = [   Sim.dwB+0.05    Sim.fB*100    Sim.kBA*2    Sim.R2B*10     ];
...
T.lowerD      = [Sim.dwD-0.1   Sim.fD*0.01    Sim.kDA/2     Sim.R2D/4            ];
T.upperD      = [Sim.dwD+0.1   Sim.fD*100     Sim.kDA*2    Sim.R2D*4            ];
...
T.lowerE      = [Sim.dwE-0.05   Sim.fE*0.01    Sim.kEA/2     Sim.R2E/10            ];
T.upperE      = [Sim.dwE+0.05   Sim.fE*100     Sim.kEA*2    Sim.R2E*100            ];
...
T.startG      = [Sim.dwG      Sim.fG        Sim.kGA       Sim.R2G        ];
T.lowerG      = [Sim.dwG-0.05   Sim.fG*0.01    Sim.kGA/2     Sim.R2G/10            ];
T.upperG      = [Sim.dwG+0.05   Sim.fG*100     Sim.kGA*2    Sim.R2G*100            ];
